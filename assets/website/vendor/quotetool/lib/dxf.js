(function(f){if(typeof exports==="object"&&typeof module!=="undefined"){module.exports=f()}else if(typeof define==="function"&&define.amd){define([],f)}else{var g;if(typeof window!=="undefined"){g=window}else if(typeof global!=="undefined"){g=global}else if(typeof self!=="undefined"){g=self}else{g=this}g.dxf = f()}})(function(){var define,module,exports;return (function(){function r(e,n,t){function o(i,f){if(!n[i]){if(!e[i]){var c="function"==typeof require&&require;if(!f&&c)return c(i,!0);if(u)return u(i,!0);var a=new Error("Cannot find module '"+i+"'");throw a.code="MODULE_NOT_FOUND",a}var p=n[i]={exports:{}};e[i][0].call(p.exports,function(r){var n=e[i][1][r];return o(n||r)},p,p.exports,r,e,n,t)}return n[i].exports}for(var u="function"==typeof require&&require,i=0;i<t.length;i++)o(t[i]);return o}return r})()({1:[function(require,module,exports){
    ...
    exports.default = _default;
},{"./util/logger":28,"lodash.clonedeep":29}],3:[function(require,module,exports){
    "use strict";
    Object.defineProperty(exports, "__esModule", {
        value: true
    });
    ...
    exports.default = _default;
},{"./util/bSpline":25,"./util/createArcForLWPolyline":27,"./util/logger":28}],4:[function(require,module,exports){
    "use strict";
    Object.defineProperty(exports, "__esModule", {
        value: true
    });
    ...
    exports.default = _default;
},{"./entities":6}],6:[function(require,module,exports){
    "use strict";
    Object.defineProperty(exports, "__esModule", {
        value: true
    });
    ...
    exports.default = _default;
},{"../util/logger":28,"./entity/arc":7,"./entity/circle":8,"./entity/ellipse":10,"./entity/insert":11,"./entity/line":12,"./entity/lwpolyline":13,"./entity/mtext":14,"./entity/point":15,"./entity/polyline":16,"./entity/solid":17,"./entity/spline":18,"./entity/vertex":19}],7:[function(require,module,exports){
    "use strict";
    Object.defineProperty(exports, "__esModule", {
        value: true
    });
    ...
    exports.default = _default;
},{"./common":9}],8:[function(require,module,exports){
    "use strict";
    Object.defineProperty(exports, "__esModule", {
        value: true
    });
    ...
    exports.default = _default;
},{"./common":9}],12:[function(require,module,exports){
    "use strict";
    Object.defineProperty(exports, "__esModule", {
        value: true
    });
    ...
    exports.default = _default;
},{"./common":9}],13:[function(require,module,exports){
    "use strict";
    Object.defineProperty(exports, "__esModule", {
        value: true
    });
    ...
    exports.default = _default;
},{"./common":9}],15:[function(require,module,exports){
    "use strict";
    Object.defineProperty(exports, "__esModule", {
        value: true
    });
    ...
    exports.default = _default;
},{"./common":9}],16:[function(require,module,exports){
    "use strict";
    Object.defineProperty(exports, "__esModule", {
        value: true
    });
    ...
    exports.default = _default;
},{"./common":9}],19:[function(require,module,exports){
    "use strict";
    Object.defineProperty(exports, "__esModule", {
        value: true
    });
    ...
    exports.default = _default;
},{"../util/logger":28}],22:[function(require,module,exports){
    "use strict";
    Object.defineProperty(exports, "__esModule", {
        value: true
    });
...
},{"./config":1,"./denormalise":2,"./groupEntitiesByLayer":4,"./handlers/blocks":5,"./handlers/entities":6,"./handlers/header":20,"./handlers/tables":21,"./toPolylines":23,"./toSVG":24,"./util/colors":26}],23:[function(require,module,exports){
    "use strict";
    Object.defineProperty(exports, "__esModule", {
        value: true
    });
    ...
    var _default = function _default(parsed) {
        ...
        var polylines = entities.map(function (entity) {
            ...
            return {
                rgb: rgb,
                vertices: (0, _entityToPolyline.default)(entity)
            };
        });
    ...
    exports.default = _default;
},{"./denormalise":2,"./entityToPolyline":3,"./util/colors":26,"./util/logger":28,"vecks":40}],24:[function(require,module,exports){
    "use strict";
    Object.defineProperty(exports, "__esModule", {
        value: true
    });
    ...
    var polylineToPath = function polylineToPath(rgb, polyline) {
        ...
        var hex = '#' + prepad; // SVG is white by default, so make white lines black
        if (hex === '#ffffff') {
            hex = '#000000';
        }
     ...
     */
    var _default = function _default(parsed) {
        var _toPolylines = (0, _toPolylines2.default)(parsed),
            bbox = _toPolylines.bbox,
            polylines = _toPolylines.polylines;
        var paths = polylines.map(function (polyline, i) {
            var vertices = polyline.vertices.map(function (v) {
                return [v[0], -v[1]];
            });
        ...
        var svgString="<input type='hidden' value='"+viewBox.width+"' id='dxf_file_width'/>";
        svgString+="<input type='hidden' value='"+viewBox.height+"' id='dxf_file_height'/><div id='svg_data_content'>";
    ...
    exports.default = _default;
},{"./toPolylines":23,"pretty-data":30}],25:[function(require,module,exports){
    "use strict";
    Object.defineProperty(exports, "__esModule", {
        value: true
    });
    ...
    exports.default = _default;
},{"round10":31}],26:[function(require,module,exports){
    "use strict";
    Object.defineProperty(exports, "__esModule", {
        value: true
    });
    ...
    exports.default = _default;
},{"vecks":40}],28:[function(require,module,exports){
    "use strict";
    Object.defineProperty(exports, "__esModule", {
        value: true
    });
    ...
    exports.default = _default;
},{"../config":1}],29:[function(require,module,exports){
    (function (global){
        /**
...
},{"./V2":38}],33:[function(require,module,exports){
    "use strict";
    Object.defineProperty(exports, "__esModule", {
        value: true
    });
...
},{"./V2":38}],35:[function(require,module,exports){
    'use strict';
    Object.defineProperty(exports, "__esModule", {
        value: true
    });
...
},{"./V3":39}],36:[function(require,module,exports){
    'use strict';
    Object.defineProperty(exports, "__esModule", {
        value: true
    });
...
},{"./V3":39}],38:[function(require,module,exports){
    'use strict';
    Object.defineProperty(exports, "__esModule", {
        value: true
    });
...
},{"./Box2":32,"./Box3":33,"./Line2":34,"./Line3":35,"./Plane3":36,"./Quaternion":37,"./V2":38,"./V3":39}]},{},[22])(22)
});
