        ...
        <div class="row">
            ...
            <div class="col-lg-6">
                <div class="post post-gray d-flex align-items-center flex-md-row flex-column">
                    <div class="thumbnail d-flex-align-items-center justify-content-center"><img src="../../../d19m59y37dris4.cloudfront.net/hub/1-4-1/img/blog-1.jpg" alt="..."></div>
                    <div class="info">
            ...
            <div class="col-lg-6">
                <div class="post post-gray d-flex align-items-center flex-md-row flex-column">
                    <div class="thumbnail d-flex-align-items-center justify-content-center"><img src="../../../d19m59y37dris4.cloudfront.net/hub/1-4-1/img/blog-2.jpg" alt="..."></div>
                    <div class="info">
            ...
            <div class="col-lg-6">
                <div class="post post-gray d-flex align-items-center flex-md-row flex-column">
                    <div class="thumbnail d-flex-align-items-center justify-content-center"><img src="../../../d19m59y37dris4.cloudfront.net/hub/1-4-1/img/blog2.jpg" alt="..."></div>
                    <div class="info">
            ...
            <div class="col-lg-6">
                <div class="post post-gray d-flex align-items-center flex-md-row flex-column">
                    <div class="thumbnail d-flex-align-items-center justify-content-center"><img src="../../../d19m59y37dris4.cloudfront.net/hub/1-4-1/img/blog1.jpg" alt="..."></div>
                    <div class="info">
