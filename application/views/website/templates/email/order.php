                                            ...
                                            <tr>
                                                <td class="es-m-p0r esd-container-frame" width="180" valign="top" align="center">
                                                    <table width="570" cellspacing="0" cellpadding="0">
                                                        <tbody>
                                                        <tr>
                                                            <td class="esd-block-image es-m-p0l es-p15l es-m-txt-c" align="center">
                                                                <a href="<?php echo base_url(); ?>" target="_blank"><img src="<?php echo base_url('assets/website/images/logo.png'); ?>" alt="onlinelaserusa logo" title="Petshop logo" width="118"></a>
                                                            </td>
                                                        </tr>
                                                        </tbody>
                                                    </table>
                                                    ...
                                                    <table style="border-radius: 0px; border-collapse: separate;" width="100%" cellspacing="0" cellpadding="0">
                                                        ...
                                                        <tr>
                                                            <td class="esd-block-text es-p5t es-p5b es-p40r es-p40l" align="center">
                                                                <p style="color: rgb(51, 51, 51);">You'll receive an email when your items are shipped. If you have any questions, Call us +1 714 732 3190.<br></p>
                                                            </td>
                                                        </tr>
                                                        </tbody>
                                                    </table>
                                                            ...
                                                            <td class="esd-block-text es-p20b es-p20r es-p20l" align="left">
                                                                <table style="width: 100%;" class="cke_show_border" cellspacing="1" cellpadding="1" border="0" align="left">
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td><span style="font-size: 14px; line-height: 150%;"><?php echo $order_details['id']; ?></span></td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td><span style="font-size: 14px; line-height: 150%;">Order Date:</span></td>
                                                                        <td><span style="font-size: 14px; line-height: 150%;"><?php echo $order_details['create_date']; ?></span></td>
                                                                    </tr>
                                                                    <tr>
                                                                        ...
                                                                        foreach ($products as $product) {
                                                                            $shipping=$shipping+($product['options']['shipping']*$product['qty']);
                                                                            $totalAmount += $product['subtotal'];
                                                                        }
                                                                        ?>
                                                                        <td><span style="font-size: 14px; line-height: 150%;">$<?php echo number_format($totalAmount+$shipping,2); ?></span></td>
                                                                    </tr>
                                                                    </tbody>
                                                                </table>
                                            ...
                                            <tr>
                                                <td class="esd-container-frame" width="600" align="left">
                                                    <table style="background-color: rgb(254, 249, 239); border-collapse: separate; border-width: 1px; border-style: solid; border-color: rgb(239, 239, 239);" width="100%" cellspacing="0" cellpadding="0" bgcolor="#fef9ef">
                                                        ...
                                                        <tr>
                                                            <td class="esd-block-text es-p20b es-p20r es-p20l" align="left">
                                                                <p><?php echo $shipping_address['first-name']." ".$shipping_address['last-name']; ?></p>
                                                                <p><?php echo $shipping_address['address'].", ".$shipping_address['city']; ?></p>
                                                                <p><?php echo $shipping_address['state'].", ".$shipping_address['country'].", ".$shipping_address['zip']."."; ?></p>
                                                            </td>
                                                        </tr>
                                                        </tbody>
                                                    </table>
                                ...
                                <tr>
                                    <td class="esd-structure es-p10t es-p10b es-p20r es-p20l" esd-general-paddings-checked="false" align="left">
                                        ...
                                        <table class="es-left" cellspacing="0" cellpadding="0" align="left">
                                            <tbody>
                                            <tr>
                                                <td class="es-m-p0r es-m-p20b esd-container-frame" width="170" valign="top" align="center">
                                                    <table width="100%" cellspacing="0" cellpadding="0">
                                                        <tbody>
                                                        <tr>
                                                            <td class="esd-block-text es-p20l" align="left">
                                                                <h4 style="padding-left: 45px;font-size: 13px;">Product ID</h4>
                                                            </td>
                                                        </tr>
                                                        </tbody>
                                                    </table>
                                                            ...
                                                            <td class="esd-block-text" align="left">
                                                                <table style="width: 100%;" class="cke_show_border" cellspacing="1" cellpadding="1" border="0">
                                                                    ...
                                                                    <tr style="line-height: 45px;">
                                                                        <td><span style="font-size:13px;">DXF File</span></td>
                                                                        <td><span style="font-size:13px;">Dimension(W X H)</span></td>
                                                                        <td><span style="font-size:13px;">Material</span></td>
<!--                                                                        <td><span style="font-size:13px;">Delivery</span></td>-->
                                                                        <td style="text-align: center;"><span style="line-height: 100%;font-size:13px;">QTY</span>
                                                                        </td>
                                                                        <td style="text-align: center;"><span style="line-height: 100%;font-size:13px;">Price</span>
                                                                        </td>
                                                                    </tr>
                                                                    </tbody>
                                                                </table>
                                            ...
                                            <table class="es-left" cellspacing="0" cellpadding="0" align="left">
                                                ...
                                                <tr>
                                                    <td class="es-m-p0r es-m-p20b esd-container-frame" width="178" valign="top" align="center">
                                                        <table width="100%" cellspacing="0" cellpadding="0" style="height: 131px;line-height: 131px;">
                                                            <tbody>
                                                            <tr>
                                                            ...
                                                            <tr>
                                                                <td class="esd-block-text" align="left">
                                                                    ...
                                                                    <table style="width: 100%;" class="cke_show_border" cellspacing="1" cellpadding="1" border="0">
                                                                        ...
                                                                        <tr>
                                                                            <?php
                                                                            $myFile = pathinfo($product['options']['dxfLink']);
                                                                            $dxfFileName=$myFile['basename'];
                                                                            ?>
                                                                            <td><a href="<?php echo base_url()."download/".$dxfFileName; ?>">Download</a></td>
                                                                            <td style="padding-left: 30px;"><?php echo $product['options']['imageWidth']." X ".$product['options']['imageHeight']." ".$product['options']['unitType']; ?></td>
                                                                            <td style="padding-left: 30px;"><?php echo $product['name']."<br/>".$product['options']['thicknessValue']; ?></td>
<!--                                                                            <td style="text-align: center;">--><?php//// echo $product['options']['shipping']==0?"Pickup":"Shipping"; ?><!--</td>-->
                                                                            <td style="text-align: center;"><?php echo $product['qty']; ?></td>
                                                                            <td style="text-align: center;">$<?php echo number_format($product['subtotal'], 2); ?></td>
                                                                        </tr>
                                                                        </tbody>
                                                                    </table>
                                                                    <p><br></p>
                                                        ...
                                                        <tr>
                                                            <td class="esd-block-text" align="right">
                                                                <table style="width: 500px;" class="cke_show_border" cellspacing="1" cellpadding="1" border="0" align="right">
                                                                    <tbody>
                                                                    <tr>
                                                                        <td style="text-align: right; font-size: 18px; line-height: 150%;">Subtotal (<?php echo count($products); ?> items):</td>
                                                                        <td style="text-align: right; font-size: 18px; line-height: 150%;">$<?php echo number_format($totalAmount, 2); ?></td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td style="text-align: right; font-size: 18px; line-height: 150%;">Shipping cost:</td>
                                                                        <td style="text-align: right; font-size: 18px; line-height: 150%; color: #d48344;"><strong>$<?php echo number_format($shipping, 2); ?></strong></td>
                                                                    </tr>
                                                                    <tr>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td style="text-align: right; font-size: 18px; line-height: 150%; color: #d48344;"><strong>$<?php echo number_format($totalAmount+$shipping, 2); ?></strong></td>
                                                                    </tr>
                                                                    </tbody>
                                                                </table>
                                                                <p style="line-height: 150%;"><br></p>
                                                    ...
                                                    <table width="100%" cellspacing="0" cellpadding="0">
                                                        ...
                                                        <tr>
                                                            <td class="esd-block-image es-m-p0l es-m-txt-c" align="left">
                                                                <a href="<?php echo base_url(); ?>" target="_blank"><img src="<?php echo base_url('assets/website/images/logo.png'); ?>" alt="Onlinelaserusa logo" title="Petshop logo" width="108"></a>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td class="esd-block-text es-p10t es-p5b es-m-txt-c" align="left">
                                                                <p>OnLine Laser is owned by Pierro LLC,</p>
                                                                <p>Longmont, Colorado, USA.</p>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td class="esd-block-text es-p5t es-m-txt-c" align="left">
                                                                <p><a target="_blank" href="tel:+80012345678">+1 714 732 3190</a><br><a target="_blank" href="mailto:support@onlinelaserusa.com">support@onlinelaserusa.com</a></p>
                                                            </td>
                                                        </tr>
                                                        </tbody>
                                                    </table>
