                                                    ...
                                                    <table width="100%" cellspacing="0" cellpadding="0">
                                                        ...
                                                        <tr>
                                                            <td class="esd-block-text es-p20l" align="left">
                                                                <h4 style="padding-left: 45px;">Product ID</h4>
                                                            </td>
                                                        </tr>
                                                        </tbody>
                                                    </table>
                                                                ...
                                                                <td class="esd-block-text" align="left">
                                                                    ...
                                                                    <table style="width: 100%;" class="cke_show_border" cellspacing="1" cellpadding="1" border="0">
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td style="text-align: center;" width="60"><?php echo $product['qty']; ?></td>
                                                                            <td style="text-align: center;" width="100">$<?php echo number_format($product['subtotal'], 2); ?></td>
                                                                        </tr>
                                                                        </tbody>
                                                                    </table>
                                                                    <p><br></p>
