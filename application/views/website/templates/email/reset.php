                                                    ...
                                                    <table width="100%" cellspacing="0" cellpadding="0">
                                                        ...
                                                        <tr>
                                                            <td class="esd-block-image es-m-p0l" align="center">
                                                                <a href="" target="_blank"><img src="https://demo.stripo.email/content/guids/4269d4af-918e-4fe4-b60e-98e1df4adf19/images/30491552716318912.png" alt="Smart home logo" title="Smart home logo" width="118" style="display: block;"></a>
                                                            </td>
                                                        </tr>
                                                        </tbody>
                                                    </table>
                                                    ...
                                                    <table width="100%" cellspacing="0" cellpadding="0">
                                                        ...
                                                        <tr>
                                                            <td class="esd-block-text" align="left">
                                                                <h1 style="color: #ff6a00; font-size: 22px;">Reset your password from here</h1>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                        ...
                                                        <tr>
                                                            <td class="esd-block-text" align="left">
                                                                <p>We've made your account ready to change password, as you asked. Your just need to click on reset your new password button. After that you will be able to reset your new password.</p>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td class="esd-block-button es-p20t es-p20b" align="left"> <span class="es-button-border" style="background: rgb(255, 255, 255);"> <a href="<?php echo $reset_link; ?>" class="es-button" target="_blank" style="padding: 5px;display: block;width: 200px;background: #FF6D00;color: #fff;text-align: center;font-size: 16px;">Reset your new password</a> </span> </td>
                                                        </tr>
                                                        <tr>
                                                            <td class="esd-block-text" align="left">
                                                                <p>If you need help visit the <a target="_blank" href="<?php echo base_url().'contact'; ?>">Help</a> page or <a target="_blank" href="<?php echo base_url().'contact'; ?>">contact us</a>.<br></p>
                                                            </td>
                                                        </tr>
                                                        </tbody>
                                                    </table>
                                                    ...
                                                    <table width="100%" cellspacing="0" cellpadding="0">
                                                        ...
                                                        <tr>
                                                            <td class="esd-block-image es-m-p0l es-p10b" align="left">
                                                                <a href="" target="_blank"><img src="https://demo.stripo.email/content/guids/4269d4af-918e-4fe4-b60e-98e1df4adf19/images/30491552716318912.png" alt="" width="103" style="display: block;"></a>
                                                            </td>
                                                        </tr>
                                                        </tbody>
                                                    </table>
                                                    ...
                                                    <table width="100%" cellspacing="0" cellpadding="0">
                                                        ...
                                                        <tr>
                                                            <td class="es-m-txt-с esd-block-text es-p10b es-m-txt-l" esdev-links-color="#333333" align="left">
                                                                <p style="color: #333333;"><span style="font-size: 20px; line-height: 150%;">+1 714 732 3190</span></p>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td class="es-m-txt-с esd-block-text es-p10b" esdev-links-color="#333333" align="left">
                                                                <div style="color: #333333;"><span style="font-size:14px;">support@onlinelaserusa.com</span></div>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                                ...
                                                                <table class="es-table-not-adapt es-social" cellspacing="0" cellpadding="0">
                                                                    ...
                                                                    <tr>
                                                                        <td class="es-p10r" valign="top" align="center">
                                                                            <a href="ttps://www.facebook.com/OnLineLaserUSA/"><img title="Facebook" src="https://stripo.email/cabinet/assets/editor/assets/img/social-icons/circle-colored/facebook-circle-colored.png" alt="Fb" width="24" height="24"></a>
                                                                        </td>
                                                                        <td valign="top" align="center">
                                                                            <a href="https://www.youtube.com/channel/UCcbxbVdn6Nyl2qv_Te2D54Q"><img title="Youtube" src="https://stripo.email/cabinet/assets/editor/assets/img/social-icons/circle-colored/youtube-circle-colored.png" alt="Yt" width="24" height="24"></a>
                                                                        </td>
                                                                    </tr>
                                                                    </tbody>
                                                                </table>
